...
export default class DateTimeField extends Component {
  ...
  onClick = () => {
    ...
    if (this.state.showPicker) {
      ...
      offset.top = offset.top + React.findDOMNode(this.refs.datetimepicker).offsetHeight;
      scrollTop = (window.pageYOffset !== undefined) ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop;
      placePosition = this.props.direction === "up" ? "top" : this.props.direction === "bottom" ? "bottom" : this.props.direction === "auto" ? offset.top + React.findDOMNode(this.refs.widget).offsetHeight > window.offsetHeight + scrollTop && this.refs.widget.offsetHeight + React.findDOMNode(this.refs.datetimepicker).offsetHeight > offset.top ? "top" : "bottom" : void 0;
      if (placePosition === "top") {
        offset.top = -React.findDOMNode(this.refs.widget).offsetHeight - React.findDOMNode(this).clientHeight - 2;
        classes.top = true;
